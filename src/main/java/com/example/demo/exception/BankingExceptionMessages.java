...
public class BankingExceptionMessages {
	public static final String AMOUNT_IS_NULL = "No amount specified. Rejected";
	public static final String AMOUNT_IS_NEGATIVE = "amount is negative. Rejected " +
			"demande";
